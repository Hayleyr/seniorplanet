...
$.getJSON('sites2.geojson',function(data){
	...
	var geojsonLayer = L.geoJson(data.features, {
      ...
      if (features.property.PCC == "PCC") { geoJsonMarkerOptions.color = "#575757"; return L.circleMarker(latlng, geojsonMarkerOptions); }
      if (features.property.PCC == "null") { geoJsonMarkerOptions.color = "#e3312b"; return L.circleMarker(latlng, geojsonMarkerOptions); }
